...
const links = {
  "For Buyers": [
    { l: "Search Properties", href: "/buy" },
    { l: "Map Search", href: "/map" },
    { l: "How It Works", href: "/how-it-works" },
    { l: "Legal Verified", href: "/buy?trust=legal" },
  ],
  "For Sellers": [
    { l: "Post Property", href: "/post-property" },
    { l: "Why Sell Here", href: "/sell" },
    { l: "Pricing Plans", href: "/pricing" },
    { l: "Seller Dashboard", href: "/dashboard" },
  ],
  Company: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-xs text-gray-700 font-medium">
            Built for trust. Built for India. 🇮🇳
          </p>
        </div>
      </div>
    </footer>
