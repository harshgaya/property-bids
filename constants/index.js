...
export const SITE = {
  ...
  description: "India's first trust-first real estate marketplace. GPS-verified listings. Live photos. Serious buyers pay ₹99 to bid.",
...
export const NAV = {
  buy: [
    { label: 'Search Properties', href: '/buy',         desc: 'Browse verified listings' },
    { label: 'Map Search',        href: '/map',          desc: 'Find properties on map' },
    { label: 'How Bidding Works', href: '/how-it-works', desc: 'Learn the bid process' },
  ],
  sell: [
    { label: 'Post Property',  href: '/post-property', desc: 'List in minutes' },
    { label: 'Seller Landing', href: '/sell',           desc: 'Why sell on PropertyBids' },
...
export const TAGS     = ['Metro', 'Gated', 'Corner', 'Main Road', 'School Zone', 'Hospital Zone']
export const AMENITIES = ['Gym', 'Swimming Pool', 'Clubhouse', 'Security', 'Power Backup', 'Parking']

// ─── LISTING PLANS ───────────────────────────────────────────────────────────
export const PLANS = [
  {
    key: 'basic', name: 'Basic Post', price: 199, priceLabel: '₹199',
    dotClass: 'bg-gray-700', highlight: false, cta: 'Post for ₹199',
    color: 'gray',
    features: [
      'Self-posted listing',
      'Up to 10 photos',
  ...
  {
    key: 'manual', name: 'Manual Verified', price: 2499, priceLabel: '₹2,499',
    dotClass: 'bg-gray-400', highlight: true, cta: 'Get Verified — ₹2,499',
    color: 'green',
    features: [
      'Everything in Basic',
  ...
  {
    key: 'legal', name: 'Legal Verified', price: 30000, priceLabel: '₹30,000',
    dotClass: 'bg-green-500', highlight: false, cta: 'Legal Verify — ₹30,000',
    color: 'emerald',
    features: [
